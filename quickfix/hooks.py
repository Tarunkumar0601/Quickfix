app_name = "quickfix"
app_title = "Quickfix"
app_publisher = "12, First Floor, 1st East Cross, Sundarapuram, Tiruppur."
app_description = "QuickFix Service Centre"
...
scheduler_events = {
	...
	# ],
	"cron": {"0 2 1 * * *": ["quickfix.reports.generate_monthly_revenue_report("]},
}
